...
impl Interpreter {
    ...
    pub(super) fn call_method(
        ...
        match object {
            ...
            Value::Int(n) => call_method_numeric(&Value::Int(n), method, &args, true),
            Value::Float(n) => call_method_numeric(&Value::Float(n), method, &args, false),
            Value::BigInt(n) => call_method_bigint(&Value::BigInt(n), method, &args),
