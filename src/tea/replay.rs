...
mod tests {
    ...
    fn replay_applies_state_mutations() {
        ...
        match result.final_model {
            Value::Dict(map) => {
                // v0.84: JSON roundtrip 保持 Int 类型（value_to_json/parse_json_number 类型对称）
